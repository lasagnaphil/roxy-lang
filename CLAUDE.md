...
- C backend Phase 5: polish (`#line` directives mapping back to Roxy source, dead-code elimination, optional Relooper/Stackifier for structured C output, optional `switch` for large enums, optional readable variable names) — see `docs/internals/c-backend.md`

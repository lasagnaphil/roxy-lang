...
bool fold_binary_const(IROp op, const IRInst* left, const IRInst* right, FoldedConst& out) {
    ...
    switch (op) {
        ...
        case IROp::DivI:
        case IROp::ModI: {
            if (left->op != IROp::ConstInt || right->op != IROp::ConstInt)
                return false;
        ...
        case IROp::BitXor: {
            ...
            u64 result = (op == IROp::BitAnd) ? (a & b) : (op == IROp::BitOr) ? (a | b) : (a ^ b);
            out.kind = FoldedConst::Kind::Int;
        ...
        case IROp::MulF:
        case IROp::DivF: {
            if (left->op != IROp::ConstF || right->op != IROp::ConstF)
                return false;
        ...
        case IROp::MulD:
        case IROp::DivD: {
            if (left->op != IROp::ConstD || right->op != IROp::ConstD)
                return false;
        ...
        case IROp::And:
        case IROp::Or: {
            if (left->op != IROp::ConstBool || right->op != IROp::ConstBool)
                return false;
...
static i64 narrow_int_to_width(i64 v, u8 bits, bool is_signed) {
    switch (bits) {
        case 8:
            return is_signed ? static_cast<i64>(static_cast<i8>(v))
                             : static_cast<i64>(static_cast<u8>(v));
        case 16:
            return is_signed ? static_cast<i64>(static_cast<i16>(v))
                             : static_cast<i64>(static_cast<u16>(v));
        case 32:
            return is_signed ? static_cast<i64>(static_cast<i32>(v))
                             : static_cast<i64>(static_cast<u32>(v));
        default:
            return v;
    }
}
...
bool fold_cast_const(const IRInst* source, const Type* source_type, const Type* target_type,
    ...
    if (!src_int && !src_bool && !src_f32 && !src_f64)
        return false;

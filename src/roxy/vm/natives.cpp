...
// Native function: u32$$to_string(val: u32) -> string
static void native_u32_to_string(RoxyVM* vm, u8 dst, u8 argc, u8 first_arg) {
    u64* regs = vm->call_stack_back().registers;
    u32 val = static_cast<u32>(regs[first_arg]);
    char buf[32];

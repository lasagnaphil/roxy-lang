...
public:
    ...
    RX_FORCEINLINE UniquePtr(UniquePtr&& other) : m_data(other.m_data) { other.m_data = nullptr; }
...
template <typename T, typename... Args> RX_FORCEINLINE UniquePtr<T> make_unique(Args&&... args) {

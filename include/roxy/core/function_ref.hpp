...
struct invoke_result_impl<
    F, decltype(rx::detail::fnref::invoke(std::declval<F>(), std::declval<Us>()...), void()),
    Us...> {
    using type = decltype(rx::detail::fnref::invoke(std::declval<F>(), std::declval<Us>()...));
};
...
public:
    ...
    template <typename F, detail::fnref::enable_if_t<

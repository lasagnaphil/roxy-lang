...
TEST_SUITE("JSON") {
    ...
    TEST_CASE("parse - float with decimal") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - float with negative exponent") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - string with escaped quotes") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - string with unicode escape") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        // \u0041 = 'A'
    ...
    TEST_CASE("parse - string with surrogate pair") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - whitespace handling") {
        BumpAllocator allocator(1024);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - in-situ string points into source buffer") {
    ...
    TEST_CASE("parse - find returns nullptr for missing key") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - object with null and bool values") {
        BumpAllocator allocator(1024);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("SAX - custom counting handler") {
    ...
    TEST_CASE("parse error - unterminated string") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse error - invalid escape") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - unexpected token") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - trailing garbage") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - truncated true") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - unterminated object") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - unterminated array") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("parse error - unexpected low surrogate") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        JsonParseError error;
    ...
    TEST_CASE("write - NaN and Inf become null") {
        String output;
        JsonWriter writer(output);
    ...
    TEST_CASE("write - string with escapes") {
        String output;
        JsonWriter writer(output);
    ...
    TEST_CASE("write - string with quotes") {
        String output;
        JsonWriter writer(output);
    ...
    TEST_CASE("write - object with values") {
        String output;
        JsonWriter writer(output);
        writer.write_start_object();
    ...
    TEST_CASE("write - array with values") {
        String output;
        JsonWriter writer(output);
        writer.write_start_array();
        writer.write_int(1);
    ...
    TEST_CASE("write - write_value for DOM tree") {
        BumpAllocator allocator(1024);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - large integer near i64 limits") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - large negative integer") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        REQUIRE(parse_json("-9223372036854775807", allocator, root, buf));
    ...
    TEST_CASE("parse - integer-only exponent is float") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - all value types in array") {
        BumpAllocator allocator(1024);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("write - key convenience helpers") {
        String output;
        JsonWriter writer(output);
        writer.write_start_object();
    ...
    TEST_CASE("parse - string with backslash") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - string with slash") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
        REQUIRE(parse_json("\"a\\/b\"", allocator, root, buf));
    ...
    TEST_CASE("parse - unicode 2-byte sequence") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("parse - unicode 3-byte sequence") {
        BumpAllocator allocator(256);
        String buf;
        JsonValue root;
    ...
    TEST_CASE("write - control character escaping") {
        String output;
        JsonWriter writer(output);

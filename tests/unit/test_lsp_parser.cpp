...
TEST_SUITE("LSP Parser") {
    ...
    TEST_CASE("Clean source produces no diagnostics") {
    ...
    TEST_CASE("Missing semicolon recovery") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Missing closing brace") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Multiple errors collected") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("CST structure for declarations") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Recovery inside struct body") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Incomplete expression") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Source range tracking") {
        BumpAllocator allocator(4096);

...
TEST_CASE("SSA IR - Constant folding: integer arithmetic") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Constant folding: integer comparisons") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Constant folding: bitwise and shifts") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Constant folding: float arithmetic") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Constant folding: unary ops") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Algebraic simplification: binary") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Algebraic simplification: unary double-negation") {
    BumpAllocator allocator(4096);
    const char* source = R"(
...
TEST_CASE("SSA IR - Constant folding: div-by-zero is NOT folded") {
    BumpAllocator allocator(4096);
    const char* source = R"(

...
TEST_SUITE("LSP GlobalIndex") {
    ...
    TEST_CASE("Empty index returns nullptr") {
        GlobalIndex index;
    ...
    TEST_CASE("Single file with struct") {
    ...
    TEST_CASE("Single file with function") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("update_file replaces old entries") {
        BumpAllocator allocator1(4096);
    ...
    TEST_CASE("remove_file clears entries") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("find_any returns struct match") {
        BumpAllocator allocator(4096);
        const char* source = "struct Point { x: f32; }";
        FileStubs stubs = parse_and_index(source, allocator);
    ...
    TEST_CASE("find_any with multiple categories") {
    ...
    TEST_CASE("Global variable indexing") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("find_node_at_offset on type reference") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("find_node_at_offset on function call") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("lsp_position_to_offset basic") {
    ...
    TEST_CASE("lsp_position_to_offset clamped") {
    ...
    TEST_CASE("Parse struct, index, lookup name_range matches CST") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Parse method, index, lookup range matches") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Named constructor lookup") {
        BumpAllocator allocator(4096);

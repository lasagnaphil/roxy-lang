...
TEST_SUITE("LSP Completion") {
    ...
    TEST_CASE("GlobalIndex: get_struct_fields returns field names") {
    ...
    TEST_CASE("GlobalIndex: get_struct_fields returns nullptr for unknown struct") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
    ...
    TEST_CASE("GlobalIndex: get_struct_methods returns method names") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Point { x: f32; }\n"
    ...
    TEST_CASE("GlobalIndex: get_enum_variants returns variant names") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
    ...
    TEST_CASE("GlobalIndex: find_function_signature") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
    ...
    TEST_CASE("GlobalIndex: find_function_signature void return") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
    ...
    TEST_CASE("GlobalIndex: find_method_signature") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Point { x: f32; }\n"
    ...
    TEST_CASE("GlobalIndex: for_each_struct iterates all structs") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Point { x: f32; }\n"
    ...
    TEST_CASE("GlobalIndex: cleanup on remove_file") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Point { x: f32; }\n"
    ...
    TEST_CASE("Integration: inherited fields in dot completion") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Base { x: i32; }\n"
    ...
    TEST_CASE("Integration: enum variant completion after ::") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index, "enum Color { Red, Green, Blue }", allocator);
    ...
    TEST_CASE("Integration: type annotation includes primitives and user types") {
        BumpAllocator allocator(4096);
        GlobalIndex index;
        setup_index(index,
            "struct Point { x: f32; }\n"
    ...
    TEST_CASE("Integration: bare identifier includes locals, globals, functions, keywords") {

...
TEST_SUITE("LSP Indexer") {
    ...
    TEST_CASE("Variable without initializer") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Constructor declaration") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Destructor declaration") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Struct with pub field") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Field with default value") {
        BumpAllocator allocator(4096);
    ...
    TEST_CASE("Function without return type") {
        BumpAllocator allocator(4096);

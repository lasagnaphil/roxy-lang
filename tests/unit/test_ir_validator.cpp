...
TEST_SUITE("IR Validator") {
    ...
    TEST_CASE("empty function (no blocks)") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("invalid ValueId in binary operand") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("ValueId out of range") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("invalid BlockId in goto target") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("block arg count mismatch") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("null type on instruction with valid result") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("block ID != array index") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("invalid branch condition") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("BlockArg index out of range") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);
    ...
    TEST_CASE("cast with null source_type") {
        BumpAllocator alloc(4096);
        TypeCache types(alloc);

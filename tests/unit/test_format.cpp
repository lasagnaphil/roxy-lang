...
TEST_SUITE("Format") {
    ...
    TEST_CASE("hex lowercase zero-padded") {
        char buf[64];
    ...
    TEST_CASE("hex uppercase zero-padded") {
        char buf[64];
    ...
    TEST_CASE("sign + zero-pad combination") {
        char buf[64];
    ...
    TEST_CASE("zero-pad negative number") {
        char buf[64];
    ...
    TEST_CASE("format spec in context") {
        char buf[128];
